...
const char ssid[] = "etis-midi";       //  your network SSID (name)
const char pass[] = "%midi564";       // your network password
...
const uint8_t SENSEBOX_ID[12] = {0x58, 0xe5, 0x35, 0x59, 0xba, 0x27, 0x90, 0x00, 0x11, 0x26, 0xef, 0x6b};

// Do not change order of sensor IDs
const sensor sensors[NUM_SENSORS] = {
// Temperatur
{ 0x58, 0xe5, 0x35, 0x59, 0xba, 0x27, 0x90, 0x00, 0x11, 0x26, 0xef, 0x6c },
// rel. Luftfeuchte
{ 0x58, 0xe5, 0x35, 0x59, 0xba, 0x27, 0x90, 0x00, 0x11, 0x26, 0xef, 0x6d },
// Luftdruck
{ 0x58, 0xe5, 0x35, 0x59, 0xba, 0x27, 0x90, 0x00, 0x11, 0x26, 0xef, 0x6e },
// Beleuchtungsstärke
{ 0x58, 0xe5, 0x35, 0x59, 0xba, 0x27, 0x90, 0x00, 0x11, 0x26, 0xef, 0x6f },
// UV-Intensität
{ 0x58, 0xe5, 0x35, 0x59, 0xba, 0x27, 0x90, 0x00, 0x11, 0x26, 0xef, 0x70 }
};
